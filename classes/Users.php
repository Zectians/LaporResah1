	...
	******************************************************************************************************/
	...
	class Users {
		...
		public function addUser($first_name, $last_name, $user_name, $email, $password, $user_dob, $user_branch) {
			...
			$preparedStatement->bind_param("sssssssisss", $first_name, $last_name, $user_name, $password1, $email, $user_dob, $user_branch, $no_of_posts, $user_role, $user_profile_img, $user_created_at);
