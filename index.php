    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid container-fluid-mine effect8" style="">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="text-align: center; font-weight: 500; text-transform: uppercase; letter-spacing: -1px;">Selamat Datang</h1>
                            <center>                            <blockquote class="blockquote">
                            <p class="mb-0">Anda dapat melihat dan melaporkan keresahan yang terjadi di lingkukngan anda di website ini</p>
                            </blockquote></center>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
